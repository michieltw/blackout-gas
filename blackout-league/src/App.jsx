...
import LeagueRecords from '@/pages/LeagueRecords';
import Venues from '@/pages/Venues';
import HelpCenter from '@/pages/HelpCenter';
import SeasonOverview from '@/pages/SeasonOverview';
import DivisionRules from '@/pages/DivisionRules';
import Inventory from '@/pages/Inventory';
import GamificationHall from '@/pages/GamificationHall';
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute unauthenticatedElement={<Navigate to="/login" replace />} />}>
        <Route element={<AppLayout />}>
          ...
          <Route path="/league-records" element={<LeagueRecords />} />
          <Route path="/venues" element={<Venues />} />
          <Route path="/help-center" element={<HelpCenter />} />
          <Route path="/season-overview" element={<SeasonOverview />} />
          <Route path="/division-rules" element={<DivisionRules />} />
          <Route path="/inventory" element={<Inventory />} />
          <Route path="/gamification-hall" element={<GamificationHall />} />
