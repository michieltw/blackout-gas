...
import { Plus, Pencil, Trash2, Shield, Users, Calendar, Trophy, Layers, RefreshCw, Code2, Save, X, ChevronDown, ChevronRight, ToggleLeft, AlertCircle } from 'lucide-react';
...
// ── Entity table row ───────────────────────────────────────────────────
function EntityRow({ record, columns, entityName, onDelete, onRawEdit, onRefresh }) {
  const { toast } = useToast();
...
function EntityTable({ rows, columns, entityName, onDelete, onRawEdit, onRefresh, emptyMsg }) {
